...
//===End Saber locks==================================================================
	...
	//Testing custom shit
	ENUM2STRING(BOTH_jedi_knight_run),
	ENUM2STRING(BOTH_battlefront_run),
	ENUM2STRING(BOTH_staff_run),
	ENUM2STRING(BOTH_single_pistol_stand),
	ENUM2STRING(BOTH_pistol_fire),
	ENUM2STRING(BOTH_light_rifle_fire),
	ENUM2STRING(BOTH_heavy_rifle_fire),
	ENUM2STRING(BOTH_rifle_stand),
	ENUM2STRING(BOTH_flamethrower),
	ENUM2STRING(BOTH_kotor_dual_stance),
	ENUM2STRING(BOTH_kotor_staff_stance),
	ENUM2STRING(BOTH_favorite_shiicho),
	ENUM2STRING(BOTH_quigon_ataru_stance),
	ENUM2STRING(BOTH_waki_red_stance),
	ENUM2STRING(BOTH_2pistol_stand),
	ENUM2STRING(BOTH_right_pistol_fire),
	ENUM2STRING(BOTH_left_pistol_fire),
	ENUM2STRING(BOTH_both_pistols_fire),
	ENUM2STRING(BOTH_pistol_run),
	ENUM2STRING(BOTH_rifle_run),
	ENUM2STRING(BOTH_force_resist),
	ENUM2STRING(BOTH_force_push),
	ENUM2STRING(BOTH_force_pull),
	ENUM2STRING(BOTH_force_lightning_1hand),
	ENUM2STRING(BOTH_force_grip),
	//======================================================
	//cinematic anims
	//======================================================
