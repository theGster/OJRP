...
//RoAR mod COMMAND LINES BEGIN
		...
		if(( Q_stricmp( arg1, "freeze" ) == 0 ) || (Q_stricmp( arg1, "amfreeze" ) == 0)){
			...
			trap_SendServerCommand( ent-g_entities, "print \"^3===^1TELEPORT ADMIN COMMAND^3===\n\n^1DESCRIPTION: ^3Teleport a client or yourself to a certain place.\n\n^5/Teleport (X)(Y)(Z)  <---- AdminTele yourself to a certain coordinate (type in /origin to see your current coordinates)\n/Teleport (client ID)  <--- Teleport a single person to you by their ID (type in /WHO to see everyones ID)\n/Teleport (client name)  <--- AdminTele a single person to you by their name\n^5You can type in /Tele instead of /Teleport.\nYou can also use... /amtele /admintele\n\n\"" );
		}
