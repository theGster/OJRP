...
//	trap_GetUserinfo( client_id, userinfo, sizeof( userinfo ) );
//	s = Info_ValueForKey( userinfo, "ip" );
	//if ( !*g_entities[client_id].client->pers.ip_info )
	//{
	//	G_Printf("client has no IP address -- are you trying to ban a bot?\n");
	//}
	//else if( !Q_stricmp("localhost", g_entities[client_id].client->pers.ip_info) )
	//{ // ip address is localhost
	//	G_Printf("you can't ban the local host client!\n");
	//}
	//else
	//{
	//	G_Printf("Banning IP: %s\n", g_entities[client_id].client->pers.ip_info);
	//	AddIP( g_entities[client_id].client->pers.ip_info );
